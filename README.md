...
3. Перейдите в Long Poll API → включите и добавьте событие "Входящие сообщения", "Исходящие сообщения", "Редактирование сообщения", "Действие с сообщением", "Разрешение на получение", "Запрет на получение"
